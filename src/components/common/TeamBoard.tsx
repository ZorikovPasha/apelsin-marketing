...
export const TeamBoard: React.FC<ITeamBoardProps> = ({ hasTitle = true }) => {
    ...
    <section className="team">
      ...
      <div className="team__container">
        <div className="team__inner">
          <div className="team__info">
            <p className="team__info-text">
              Более 10 лет команда Константина Валуйкина создаёт стильные интерьеры и авторскую
              архитектуру.
            </p>
            <br />
            <p className="team__info-text">
              За эти годы нашими профессионалами введены в эксплуатацию более 100 бъектов как жилой,
          ...
          <div className="team__founder-info">
            <p className="team__founder-name">Константин Валуйкин</p>
            <p className="team__founder-position">Руководитель студии</p>
            <p className="team__founder-text">
              Сотни довольных Заказчиков стали друзьями нашей студии, рекомендуют нас и обращаются
              вновь и вновь.
            </p>
            <p className="team__founder-geography">География наших проектов разнообразна.</p>
        ...
        <div className="section__link-wrapper">
          <Link className="section__link" to={ROUTES.Press}>
            Подробнее о нас
            <svg
