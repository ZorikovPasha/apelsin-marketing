...
const Home = () => {
  ...
  const projects = [
    { location: "Флорида", name: "Загородный дом в посёлке Комильфо" },
    { location: "Флорида", name: "Загородный дом в посёлке Комильфо" },
    { location: "Флорида", name: "Загородный дом в посёлке Комильфо" },
    { location: "Флорида", name: "Загородный дом в посёлке Комильфо" },
  ]

  const services = ["Дизайн", "Архитектура", "Генеральный подряд", "Ландшафный дизайн", "Девелоперам" ]
      ...
      <section className="clients">
        ...
        <div className="container-fluid">
          <div className="clients-video">
            <a 
              className="clients-video__play" 
              href="https://youtu.be/7OcK1TMnbe0" 
              data-fancybox
            >
              <img src={Play} alt=""/>
            </a>
              ...
              <div className="services__item" key={text}>
                ...
                <a className="services__item-link item-link" href="#">
                  ...
                  <svg width="24" height="22" viewBox="0 0 24 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" clipRule="evenodd" d="M12.7045 1.2045C13.1439 0.765166 13.8561 0.765166 14.2954 1.2045L23.2954 10.2045C23.7348 10.6439 23.7348 11.3561 23.2954 11.7954L14.2954 20.7955C13.8561 21.2348 13.1439 21.2348 12.7045 20.7955C12.2652 20.3561 12.2652 19.6439 12.7045 19.2045L19.7839 12.125H1.5C0.878685 12.125 0.375 11.6213 0.375 11C0.375 10.3787 0.878685 9.875 1.5 9.875H19.7839L12.7045 2.79549C12.2652 2.35616 12.2652 1.64384 12.7045 1.2045Z" fill="#101010"/>
                  </svg>
                </a>
              </div>
            ))}
